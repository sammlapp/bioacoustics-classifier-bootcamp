...
## 15:10 — Project Updates
- Discussion of current project status.
- Students waiting for Macaulay recordings.
- Green frog project — no XenoCanto recordings available.
- Recommendation:
  - Continue training with existing annotated data.
  - Build training/validation splits while waiting on new data.

---

## 15:12 — Training Progress
- Few have begun training models yet.
- Evaluation topic postponed until next week.
- Focus for today: **Embeddings and Transfer Learning**.
- Encouragement to try **training even a small model** this week.
